-- TODO this is not plugged in because it references things I don't use (yet)
-- and I don't have the time to fix it now. But I'd like some day get this status
-- line to work, because it's slick!
---
...
local function file_name()
	...
	local highlight_group = vim.bo.modified and filename ~= "[no name]" and "statusline_modifiedfile"
		or "statusline_file"
